...
# ──────────────────────────────────────────────────────────────────────────────
def run_model(cel_pct, hemi_pct, lig_pct, ash_pct):
    # HTT is fixed at 500°C as per experimental reference (Excel C8=500)
    # Valid range: 450–850°C
    HTT = 500
...
with st.sidebar:
    ...
    st.markdown(
        ...
        "Process temperature: HTT = 500°C (fixed)<br>"
        "Valid range: 450–850 °C<br>"
...
<div class="banner">
  ...
  <p>Mass &amp; Energy Balance Model · 1 kg Basis · Slow Pyrolysis · HTT = 500°C (fixed)</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown(
    ...
    "Slow pyrolysis · HTT = 500°C (fixed) · Valid range: 450–850 °C · Residence time: 15 minutes · Basis: 1 kg dry biomass"
    "</div>",
    unsafe_allow_html=True,
)
